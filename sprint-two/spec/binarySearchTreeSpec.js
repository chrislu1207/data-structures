describe('binarySearchTree', function() {
  ...
  it('should execute a callback on every value in a tree using "depthFirstLog" and go right', function() {
    var array = [];
    var func = function(value) { array.push(value); };
    binarySearchTree.insert(2);
    binarySearchTree.insert(3);
  ...
  it('should execute a callback on every value in a tree using "breadthFirstLog" and go right', function() {
    var array = [];
    var func = function(value) { array.push(value); };
    binarySearchTree.insert(2);
    binarySearchTree.insert(3);
